...
export class Test3 extends Component {
  ...
  fetchItems = () => {
    ...
    let shouldScroll = offsetWidth === scrollWidth + scrollLeft;
    if (!shouldScroll && this.lastItem) {
      const { clientWidth } = this.lastItem.current;
      shouldScroll = offsetWidth + clientWidth >= scrollWidth + scrollLeft;
    }
  ...
  handleScroll = (e) => {
    ...
    const canScrollLeft = offsetWidth + 1 < scrollWidth + scrollLeft;
    const canScrollRight = scrollLeft < 0;
